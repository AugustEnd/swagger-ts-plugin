...
var defaultValue_1 = require("../create/defaultValue");
    ...
    return _regenerator["default"].wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return index_1.startCreate(_objectSpread(_objectSpread({}, defaultValue_1["default"]), {}, {
              serverList: ["fs-service", "sms-service", "trialpartner-web", "econfig-web", "zhiyi-app"],
