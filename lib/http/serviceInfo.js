    ...
    return _regenerator["default"].wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            url = global.options.appUrl || "http://eureka.dev.com:1111/eureka/apps"; // console.log(
            //     "\x1B[32m%s\x1B[0m",
            //     `swagger2ts插件生成的数据属于 ${
          ...
          case 4:
            ...
            return new _promise["default"](function (resolve, reject) {
              msg.on("end", function () {
                var _parser$parse, _parser$parse$applica;

                resolve({
                  data: ((_parser$parse = parser.parse(rawData)) === null || _parser$parse === void 0 ? void 0 : (_parser$parse$applica = _parser$parse.applications) === null || _parser$parse$applica === void 0 ? void 0 : _parser$parse$applica.application) || []
                });
              });
            });
