...
function _getTranslateInfo() {
  _getTranslateInfo = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee2(values) {
    var _options$fanyi;

    var _global, options, translationObj, _options$fanyi$baidu, maxLimit, appid, secretKey, qList, salt, loop, _loop;
