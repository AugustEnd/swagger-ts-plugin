...
var collectChinese = function collectChinese(values) {
  ...
  (0, _map["default"])(values).call(values, function (item) {
    for (var key in item === null || item === void 0 ? void 0 : item.data) {
      ...
      var all = (0, _map["default"])(_context = (0, _toConsumableArray2["default"])(common_1.handleSpecialSymbol(key).matchAll(/[\u4e00-\u9fa5]+/g))).call(_context, function (el) {
        return el[0];
      });
    ...
    for (var _key in item === null || item === void 0 ? void 0 : item.paths) {
      ...
      for (method in val) {
        ...
        var _all = (0, _map["default"])(_context2 = (0, _toConsumableArray2["default"])(common_1.handleSpecialSymbol(dto).matchAll(/[\u4e00-\u9fa5]+/g))).call(_context2, function (el) {
          return el[0];
        });
...
var exchangeZhToEn = function exchangeZhToEn(str) {
  ...
  var zhToEnMap = global.swagger2global.transitions;
