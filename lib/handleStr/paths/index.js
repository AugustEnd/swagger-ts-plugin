...
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { var _context19; _forEachInstanceProperty(_context19 = ownKeys(Object(source), true)).call(_context19, function (key) { (0, _defineProperty2["default"])(target, key, source[key]); }); } else if (_Object$getOwnPropertyDescriptors) { _Object$defineProperties(target, _Object$getOwnPropertyDescriptors(source)); } else { var _context20; _forEachInstanceProperty(_context20 = ownKeys(Object(source))).call(_context20, function (key) { _Object$defineProperty2(target, key, _Object$getOwnPropertyDescriptor(source, key)); }); } } return target; }
...
var completePath = function completePath(key, val) {
  ...
  for (var method in val) {
    ...
    var paramObj = exports.requestType((0, _filter["default"])(_context = (0, _concat["default"])(commonParam).call(commonParam, parameters)).call(_context, function (el) {
      return el;
    }));
    var importNames = paramObj.importNames;
    str = (0, _concat["default"])(_context2 = (0, _concat["default"])(_context3 = (0, _concat["default"])(_context4 = (0, _concat["default"])(_context5 = (0, _concat["default"])(_context6 = (0, _concat["default"])(_context7 = "    \"".concat(key)).call(_context7, (0, _keys["default"])(val).length !== 1 ? "|".concat(method) : "", "\": {\n            method: \"")).call(_context6, method, "\";\n            parameters:")).call(_context5, paramObj.params, ",\n            paramsList:")).call(_context4, (0, _stringify["default"])(paramObj.reqType), "\n            operationId:\"")).call(_context3, operationId, "\",\n            data: ")).call(_context2, type === "array" ? "Array<".concat(importName ? importName : null, ">") : importName ? importName : null, ";\n        };");
          ...
          case 0:
            ...
            for (key in paths) {
              ...
              (0, _map["default"])(onePaths).call(onePaths, function (onePath) {
                ...
                (0, _map["default"])(_context8 = onePath.importName).call(_context8, function (el) {
            ...
            str = (0, _concat["default"])(_context9 = "import {".concat(importList.join(","), "} from './interface.d';\nexport interface pathsObj {\n")).call(_context9, str, "}"); // 当前服务所有请求函数
...
var requestType = function requestType(parameters) {
  ...
  var queryStr = (0, _reduce["default"])(query).call(query, function (a, b) {
    ...
    return (0, _concat["default"])(_context11 = (0, _concat["default"])(_context12 = (0, _concat["default"])(_context13 = "".concat(a, "\"")).call(_context13, b.name, "\"")).call(_context12, !b.required ? "?" : "", ": ")).call(_context11, interface_1.switchType(b.type, undefined, "strict", b.required, b === null || b === void 0 ? void 0 : b["enum"], undefined), ";");
  }, "");
  var pathStr = (0, _reduce["default"])(path).call(path, function (a, b) {
    var _context14, _context15;

    return (0, _concat["default"])(_context14 = (0, _concat["default"])(_context15 = "".concat(a)).call(_context15, b.name, ": ")).call(_context14, interface_1.switchType(b.type, undefined, "strict", b.required, b === null || b === void 0 ? void 0 : b["enum"], undefined), ";");
  }, "");
  ...
  return {
    params: (0, _concat["default"])(_context16 = (0, _concat["default"])(_context17 = (0, _concat["default"])(_context18 = "{".concat(queryStr ? "\n            query:{\n                ".concat(queryStr, "\n            };") : "")).call(_context18, pathStr ? "\n            path:{\n                ".concat(pathStr, "\n            }") : "")).call(_context17, bodyStr ? "\n            body:".concat(bodyStr, "\n            ") : "")).call(_context16, formDataStr ? "formData: ".concat(formDataStr) : "", "\n        }"),
    reqType: {
      query: !!queryStr,
      path: !!pathStr,
      body: !!bodyStr,
