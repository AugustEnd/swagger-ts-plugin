...
var completePathAll = /*#__PURE__*/function () {
  var _ref = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(paths, options) {
    ...
    var newOptions, str, importSet, pathInfoList, key, _context6, onePath, importList, fnStr;
        ...
        switch (_context8.prev = _context8.next) {
          case 0:
            ...
            for (key in paths) {
              ...
              (0, _map["default"])(_context6 = onePath.importName).call(_context6, function (el) {
            ...
            str = (0, _concat["default"])(_context7 = "import {".concat(importList.join(","), "} from './interface.d';\nexport interface pathsObj {\n")).call(_context7, str, "}"); // 当前服务所有请求函数
...
var requestType = function requestType(parameters) {
  ...
  var queryStr = (0, _reduce["default"])(query).call(query, function (a, b) {
    ...
    return (0, _concat["default"])(_context9 = (0, _concat["default"])(_context10 = "".concat(a, "\"")).call(_context10, b.name, "\": ")).call(_context9, interface_1.switchType(b.type, undefined, "strict", undefined), ";");
  }, "");
  var pathStr = (0, _reduce["default"])(path).call(path, function (a, b) {
    var _context11, _context12;

    return (0, _concat["default"])(_context11 = (0, _concat["default"])(_context12 = "".concat(a)).call(_context12, b.name, ": ")).call(_context11, interface_1.switchType(b.type, undefined, "strict", undefined), ";");
  }, "");
  var bodyStr = (0, _reduce["default"])(body).call(body, function (a, b) {
    if (b !== null && b !== void 0 && b.schema) {
      ...
      var name = interface_1.switchType(b.type, ((_b$schema = b.schema) === null || _b$schema === void 0 ? void 0 : (_b$schema$$ref = _b$schema.$ref) === null || _b$schema$$ref === void 0 ? void 0 : _b$schema$$ref.split("/")[2]) || null, "strict", function (name) {
  ...
  return {
    params: (0, _concat["default"])(_context13 = (0, _concat["default"])(_context14 = (0, _concat["default"])(_context15 = "{".concat(queryStr ? "\n            query:{\n                ".concat(queryStr, "\n            };") : "")).call(_context15, pathStr ? "\n            path:{\n                ".concat(pathStr, "\n            }") : "")).call(_context14, bodyStr ? "\n            body:".concat(bodyStr, "\n            ") : "")).call(_context13, formDataStr ? "formData: ".concat(formDataStr) : "", "\n        }"),
    reqType: {
      query: !!queryStr,
      path: !!pathStr,
      body: !!bodyStr,
