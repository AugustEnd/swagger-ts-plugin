...
var currentServiceFn = function currentServiceFn(list, importList) {
  ...
  return (0, _concat["default"])(_context13 = (0, _concat["default"])(_context14 = "import {".concat(importList.join(","), "} from './interface.d';\n\n    // \u628A\u52A8\u6001\u8DEF\u7531\u52A0\u5165\u5230url\u4E2D\n    const pathAddToUrl = (url: string, pathObj: any): string =>\n        url.replace(\n            /{[0-9A-Za-z]+}/g,\n            (val) => pathObj[val.slice(1, val.length - 1)]\n        );\n    \n    ")).call(_context14, str, "\n    ")).call(_context13, exports.exportFn(fnIds));
};
...
var exportSwitchMaps = function exportSwitchMaps(obj) {
  ...
  return "export interface __switchMaps {".concat((0, _reduce["default"])(_context15 = (0, _keys["default"])(obj)).call(_context15, function (prev, next) {
    var _context16;

    return prev += (0, _concat["default"])(_context16 = "\"".concat(obj[next], "\": typeof ")).call(_context16, next, ";");
  }, ""), "}");
};
...
var exportFn = function exportFn(ids) {
  ...
  return "export default function<T> (http:T) {\n        return {\n        ".concat((0, _reduce["default"])(_context17 = (0, _concat["default"])(ids).call(ids, {
    operationId: "http",
    url: "__http",
    urlAsId: true
  })).call(_context17, function (prev, next) {
    var _context18, _context19, _context20, _context21, _context22;

    // 使用id作为标识
    // return prev ? prev + ", " + next.operationId : next.operationId;
    // 使用url作为标识
    var extra = !next.urlAsId ? "|" + next.method : "";
    return prev ? (0, _concat["default"])(_context18 = (0, _concat["default"])(_context19 = (0, _concat["default"])(_context20 = "".concat(prev, ", \"")).call(_context20, next.url)).call(_context19, extra, "\":")).call(_context18, next.operationId) : (0, _concat["default"])(_context21 = (0, _concat["default"])(_context22 = "\"".concat(next.url)).call(_context22, extra, "\":")).call(_context21, next.operationId);
  }, ""), "\n        }\n    }");
};
